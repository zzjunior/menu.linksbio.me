                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ $formData['description'] ?? $category['description'] ?? '' }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="image_url" 
                               name="image_url" 
                               value="{{ $formData['image_url'] ?? $category['image_url'] ?? '' }}"
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <div class="flex items-start">
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   @if ((isset($formData['has_customization']) ? $formData['has_customization'] : ($category['has_customization'] ?? false))) checked @endif
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="sort_order" 
                               name="sort_order" 
                               value="{{ $formData['sort_order'] ?? $category['sort_order'] ?? 0 }}"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        <p class="mt-1 text-sm text-gray-500">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               name="is_active" 
                               value="1"
                               @if ((isset($formData['is_active']) ? $formData['is_active'] : ($category['is_active'] ?? true))) checked @endif
